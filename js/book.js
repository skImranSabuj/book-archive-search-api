        ...
        div.innerHTML = `
            <div onclick="loadMealDetails(${book.idMeal})" class="card" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="card-body">
                    ...
                    <h6 class="card-text"><b>Author Name:</b> ${book.author_name}</h6>
                    <h6 class="card-text"><b>First Published:</b> ${book.first_publish_year} </h6>
                    <p class="card-text"><b>Publishers: </b> ${book.publisher}</p>
                </div>
            </div>
        `;
